...
var PrivacyPolicyPage = (function () {
    ...
    PrivacyPolicyPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'privacy-policy-page',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/privacy-policy/privacy-policy.html"*/'<ion-header class="privacy-header legal-header">\n  <ion-toolbar>\n    <ion-buttons start>\n      <button ion-button (click)="dismiss()">\n        <span showWhen="ios">{{\'CANCEL\' | translate}}</span>\n        <ion-icon name="md-close" showWhen="android,windows"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>\n      {{\'PRIVACY_POLICY\' | translate }}\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class="privacy-content legal-content">\n  <p>{{\'LAST_MODIFIED\' | translate }}: Nov 14, 2016</p>\n  <h4 class="legal-title">{{\'WELCOME_TO\' | translate}} ion2FullApp!</h4>\n  <p>Thanks for using our products and services (“Services”). Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>\n  <h4 class="legal-title">{{\'USING_OUR_SERVICES\' | translate}}</h4>\n  <p>You must follow any policies made available to you within the Services.</p>\n  <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>\n  <h4 class="legal-title">{{\'ABOUT_THIS_TERMS\' | translate}}</h4>\n  <p>We may modify these terms or any additional terms that apply to a Service to, for example, reflect changes to the law or changes to our Services. You should look at the terms regularly. We’ll post notice of modifications to these terms on this page. We’ll post notice of modified additional terms in the applicable Service. Changes will not apply retroactively and will become effective no sooner than fourteen days after they are posted. However, changes addressing new functions for a Service or changes made for legal reasons will be effective immediately. If you do not agree to the modified terms for a Service, you should discontinue your use of that Service.</p>\n</ion-content>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/privacy-policy/privacy-policy.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ViewController"]])
    ], PrivacyPolicyPage);
...
var CounterInput = (function () {
    ...
    CounterInput = CounterInput_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'counter-input',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/counter-input/counter-input.html"*/'<button ion-button icon-only class="counter-icon" (click)="decrease()">\n  <ion-icon name="remove"></ion-icon>\n</button>\n<span class="counter-inner">{{counterValue}}</span>\n<button ion-button icon-only class="counter-icon" (click)="increase()">\n  <ion-icon name="add"></ion-icon>\n</button>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/counter-input/counter-input.html"*/,
            host: {
                'class': 'counter-input'
            },
            providers: [
...
var FirebaseTabsNavigationPage = (function () {
    ...
    FirebaseTabsNavigationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'firebase-tabs-navigation',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/firebase-integration/firebase-tabs-navigation/firebase-tabs-navigation.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="{{\'FEED\' | translate}}" tabIcon="apps"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="{{\'PROFILE\' | translate}}" tabIcon="person"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/firebase-integration/firebase-tabs-navigation/firebase-tabs-navigation.html"*/
        }),
...
var FirebaseAvatarSelect = (function () {
    ...
    FirebaseAvatarSelect = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'firebase-avatar-select-page',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/firebase-integration/firebase-avatar-select/firebase-avatar-select.html"*/'<ion-row>\n  <ion-col width-50 *ngFor="let avatar of avatars">\n    <div (click)="close(avatar)">\n      <img [src]=avatar.link>\n    </div>\n  </ion-col>\n</ion-row>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/firebase-integration/firebase-avatar-select/firebase-avatar-select.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ViewController"],
...
var FunctionalitiesPage = (function () {
    ...
    FunctionalitiesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'functionalities-page',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/functionalities/functionalities.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>News</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="functionalities-content">\n  <ion-list class="functionalities-list">\n    <button class="list-item" ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-row no-padding>\n        <ion-col no-padding class="item-content">\n          <h3 class="item-title">{{item.title}}</h3>\n          <span class="item-note" *ngIf="item.note">{{item.note}}</span>\n        </ion-col>\n        <ion-col no-padding width-10 class="item-icon">\n          <ion-icon name="arrow-forward"></ion-icon>\n        </ion-col>\n      </ion-row>\n    </button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/functionalities/functionalities.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
...
var FirebaseLoginPage = (function () {
    ...
    FirebaseLoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'firebase-login-page',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/firebase-integration/firebase-login/firebase-login.html"*/'<ion-header class="login-header auth-header">\n  <ion-navbar>\n    <ion-title>Sports</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="login-content auth-content">\n  <form class="login-form auth-form" [formGroup]="login" (ngSubmit)="doLogin(login.value)">\n    <ion-item>\n      <ion-input type="email" placeholder="Email" formControlName="email"></ion-input>\n    </ion-item>\n    <show-hide-container>\n      <ion-item>\n        <ion-input type="password" placeholder="Password" formControlName="password" show-hide-input></ion-input>\n      </ion-item>\n    </show-hide-container>\n    <button ion-button block class="auth-action-button login-button" type="submit" [disabled]="!login.valid">{{\'LOG_IN\' | translate}}</button>\n  </form>\n  <ion-row class="alt-options">\n    <ion-col no-padding width-50>\n    </ion-col>\n    <ion-col no-padding width-50>\n      <button ion-button block clear class="signup-button" (click)="goToSignup()">{{\'SIGN_UP!\' | translate}}</button>\n    </ion-col>\n  </ion-row>\n  <label class="error-message">{{errorMessage}}</label>\n  <p class="auth-divider">\n    Or\n  </p>\n  <button ion-button block class="facebook-auth-button" (click)="doFacebookLogin()">Log in with Facebook</button>\n  <button ion-button block class="google-auth-button" (click)="doGoogleLogin()">Log in with Google</button>\n  <button ion-button block class="twitter-auth-button" (click)="doTwitterLogin()">Log in with Twitter</button>\n</ion-content>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/firebase-integration/firebase-login/firebase-login.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"],
...
var FirebaseSignupPage = (function () {
    ...
    FirebaseSignupPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'firebase-signup-page',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/firebase-integration/firebase-signup/firebase-signup.html"*/'<ion-header class="signup-header auth-header">\n  <ion-navbar>\n    <ion-title>{{\'SIGN_UP\' | translate}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="signup-content auth-content">\n  <h2 class="auth-title">{{\'CREATE_AN_ACCOUNT\' | translate}}</h2>\n  <form class="signup-form auth-form" [formGroup]="signup" (ngSubmit)="doSignup(signup.value)">\n    <ion-item>\n      <ion-input type="email" placeholder="Email" formControlName="email"></ion-input>\n    </ion-item>\n    <show-hide-container>\n      <ion-item>\n        <ion-input type="password" placeholder="Password" formControlName="password" show-hide-input></ion-input>\n      </ion-item>\n    </show-hide-container>\n    <button ion-button block class="auth-action-button signup-button" type="submit" [disabled]="!signup.valid">{{\'SIGN_UP\' | translate}}</button>\n  </form>\n  <label class="error-message">{{errorMessage}}</label>\n  <p class="auth-divider">\n    Or\n  </p>\n  <button ion-button block class="facebook-auth-button" (click)="doFacebookSignup()">{{\'SIGN_UP_WITH_FACEBOOK\' | translate}}</button>\n  <button ion-button block class="google-auth-button" (click)="doGoogleSignup()">{{\'SIGN_UP_WITH_GOOGLE\' | translate}}</button>\n  <button ion-button block class="twitter-auth-button" (click)="doTwitterSignup()">{{\'SIGN_UP_WITH_TWITTER\' | translate}}</button>\n</ion-content>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/firebase-integration/firebase-signup/firebase-signup.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"],
...
var WordpressMenuPage = (function () {
    ...
    WordpressMenuPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'wordpress-menu-page',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/wordpress-integration/wordpress-menu/wordpress-menu.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>{{ \'HEALTH\' | translate }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="wordpress-menu-content">\n  <ion-list class="wordpress-menu-list">\n    <button class="list-item" ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-row no-padding>\n        <ion-col no-padding class="item-content">\n          <h3 class="item-title">{{item.title}}</h3>\n          <span class="item-note" *ngIf="item.note">{{item.note}}</span>\n        </ion-col>\n        <ion-col no-padding width-10 class="item-icon">\n          <ion-icon name="arrow-forward"></ion-icon>\n        </ion-col>\n      </ion-row>\n    </button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/wordpress-integration/wordpress-menu/wordpress-menu.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"]])
    ], WordpressMenuPage);
...
var BlogCategoriesPage = (function () {
    ...
    BlogCategoriesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-blog-categories',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/wordpress-integration/blog-categories/blog-categories.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>Categories</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="list-mini-content">\n\n  <div class="list-mini">\n\n    <ion-list>\n\n      <button class="list-item" ion-item *ngFor="let category of categories" (click)="itemTapped($event, category)">\n\n        <ion-row no-padding class="content-row one-line">\n\n          <ion-col no-padding class="item-content">\n\n            <h3 class="item-title">{{category.name}}</h3>\n\n            <p class="item-description">{{category.description}}</p>\n\n          </ion-col>\n\n          <ion-col no-padding width-10 class="item-icon">\n\n            <ion-icon name="arrow-forward"></ion-icon>\n\n          </ion-col>\n\n        </ion-row>\n\n      </button>\n\n    </ion-list>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/wordpress-integration/blog-categories/blog-categories.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"],
...
var BlogCustomPagesPage = (function () {
    ...
    BlogCustomPagesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-blog-custom-pages',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/wordpress-integration/blog-custom-pages/blog-custom-pages.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>Custom Pages</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="list-mini-content">\n\n  <div class="list-mini">\n\n    <ion-list>\n\n      <button class="list-item" ion-item *ngFor="let page of pages" (click)="itemTapped($event, page)">\n\n        <ion-row no-padding class="content-row one-line">\n\n          <ion-col no-padding class="item-content">\n\n            <h3 class="item-title">{{page.title.rendered}}</h3>\n\n          </ion-col>\n\n          <ion-col no-padding width-10 class="item-icon">\n\n            <ion-icon name="arrow-forward"></ion-icon>\n\n          </ion-col>\n\n        </ion-row>\n\n      </button>\n\n    </ion-list>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/wordpress-integration/blog-custom-pages/blog-custom-pages.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"],
            __WEBPACK_IMPORTED_MODULE_2__wordpress_integration_service__["a" /* WordpressService */]])
...
var BlogCustomPagePage = (function () {
    ...
    BlogCustomPagePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-blog-custom-page',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/wordpress-integration/blog-custom-page/blog-custom-page.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>Custom Page</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="custom-page-content">\n\n  <div *ngIf="page" class="blog-page">\n\n    <div class="page-title" [innerHTML]="page.title.rendered"></div>\n\n    <p class="page-content" [innerHTML]="page.content.rendered"></p>\n\n    <p class="page-date">Published on {{page.date.split(\'T\')[0]}}</p>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/wordpress-integration/blog-custom-page/blog-custom-page.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"],
            __WEBPACK_IMPORTED_MODULE_2__wordpress_integration_service__["a" /* WordpressService */]])
...
var LayoutsPage = (function () {
    ...
    LayoutsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'layouts-page',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/layouts/layouts.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{\'POLITICS\' | translate}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="layouts-content">\n  <ion-list class="layouts-list">\n    <button class="list-item" ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-row no-padding>\n        <ion-col no-padding class="item-content">\n          <h3 class="item-title">{{item.title}}</h3>\n          <span class="item-note" *ngIf="item.note">{{item.note}}</span>\n        </ion-col>\n        <ion-col no-padding width-10 class="item-icon">\n          <ion-icon name="arrow-forward"></ion-icon>\n        </ion-col>\n      </ion-row>\n    </button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/layouts/layouts.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
            __WEBPACK_IMPORTED_MODULE_9__ngx_translate_core__["c" /* TranslateService */]])
    ], LayoutsPage);
...
var PreloadImage = (function () {
    ...
    PreloadImage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'preload-image',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/preload-image/preload-image.html"*/'<ion-spinner name="bubbles"></ion-spinner>\n<ng-content></ng-content>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/preload-image/preload-image.html"*/
        }),
...
var BackgroundImage = (function () {
    ...
    BackgroundImage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'background-image',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/background-image/background-image.html"*/'<span class="bg-overlay"></span>\n<ion-spinner name="bubbles"></ion-spinner>\n<ng-content></ng-content>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/background-image/background-image.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"], __WEBPACK_IMPORTED_MODULE_0__angular_core__["Renderer"]])
    ], BackgroundImage);
...
var ShowHideContainer = (function () {
    ...
    ShowHideContainer = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'show-hide-container',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/show-hide-password/show-hide-password.html"*/'<ng-content></ng-content>\n<a class="type-toggle" (click)="toggleShow()">\n	<ion-icon class="show-option" [hidden]="show" name="eye"></ion-icon>\n	<ion-icon class="hide-option" [hidden]="!show" name="eye-off"></ion-icon>\n</a>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/show-hide-password/show-hide-password.html"*/,
            host: {
...
var Rating = (function () {
    ...
    Rating = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'rating',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/rating/rating.html"*/'<button class="rating-icon" ion-button icon-only round *ngFor="let r of range; let i = index" (click)="rate(i + 1)">\n	<ion-icon [name]="value === undefined ? (r === 1 ? \'star\' : (r === 2 ? \'star-half\' : \'star-outline\')) : (value > i ? (value < i+1 ? \'star-half\' : \'star\') : \'star-outline\')"></ion-icon>\n</button>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/components/rating/rating.html"*/,
...
var LayoutsPage = (function () {
    ...
    LayoutsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'layouts-page',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/recent/layouts.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{\'RECENT\'}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="layouts-content">\n  <ion-list class="layouts-list">\n    <button class="list-item" ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-row no-padding>\n        <ion-col no-padding class="item-content">\n          <h3 class="item-title">{{item.title}}</h3>\n          <span class="item-note" *ngIf="item.note">{{item.note}}</span>\n        </ion-col>\n        <ion-col no-padding width-10 class="item-icon">\n          <ion-icon name="arrow-forward"></ion-icon>\n        </ion-col>\n      </ion-row>\n    </button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/recent/layouts.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
            __WEBPACK_IMPORTED_MODULE_9__ngx_translate_core__["c" /* TranslateService */]])
    ], LayoutsPage);
...
var TabsNavigationPage = (function () {
    ...
    TabsNavigationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'tabs-navigation',template:/*ion-inline-start:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/tabs-navigation/tabs-navigation.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="{{\'LISTING\' | translate}}" tabIcon="apps"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="{{\'PROFILE\' | translate}}" tabIcon="person"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="{{\'NOTIFICATIONS\' | translate}}" tabIcon="notifications"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/alvin/Work/hyroglf_4a/hyro/src/pages/tabs-navigation/tabs-navigation.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], TabsNavigationPage);
